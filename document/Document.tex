...
\begin{figure}[H]
\caption{Salario por Hora} \label{fig:1_histo_sal}
    \includegraphics[scale=0.75]{../views/1_histo_sal.png}   
 \flushleft
 \textit{Nota:} La figura muestra el histograma del salario por hora de la muestra. La línea roja presenta la media y la azul la mediana.
\end{figure}

\begin{figure}[H]
\caption{Logaritmo del Salario por Hora} \label{fig:1_histo_sal_hora}
    \includegraphics[scale=0.75]{../views/1_histo_sal_hora.png}   
 \flushleft
 \textit{Nota:} La figura muestra el histograma del logaritmo natural del salario por hora de la muestra. La línea roja presenta la media y la azul la mediana.
\end{figure}
