...
Asimismo, suele utilizarse la variable de ingreso en logaritmos, lo que mejora la interpretabilidad del coeficiente estimado, que pasaría a representar cuánto impacta, en términos porcentuales, una unidad adicional de la variable independiente sobre el ingreso, en este caso un año adional en la edad.
...
\end{equation}
Donde $w_i$ es el ingreso salarial por hora del individuo $i$ y $Age_i$ es su edad. Se realizó la estimación del modelo con las diferentes medidas de ingreso salarial nominal y real:
