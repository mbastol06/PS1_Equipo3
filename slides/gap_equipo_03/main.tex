...
\titlegraphic{\vspace{1cm}\includegraphics[width=2.5cm]{../../views/logo.png}}
...
\begin{itemize}
    ...
    \item Usualmente se suele usar salario por hora, pero para analisar su robustez, agregamos otras medidas de salario.
...
\hline \\[-1.8ex] 
 ...
 Primaria Incpmpleta &  &  & 0.199$^{**}$ & 0.222$^{**}$ & 0.167$^{**}$ \\ 
